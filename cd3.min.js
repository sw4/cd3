...
(a=a.toLowerCase());a&&"x"!=a||(w.call(p),M("x"));a&&"y"!=a||(B.call(q),M("y"))}function s(b,c){var e="x"==b?h:g;b=b.toLowerCase();c||(c=a[b+"Axis"].scale);if("string"===typeof c)switch(c){case "time":e=d3.time.scale();break;default:case "linear":e=d3.scale.linear();break;case "ordinal":e=d3.scale.ordinal()}a[b+"Axis"].scale=c;"x"==b?h=e:g=e;v(b,a[b+"Axis"].range);y(b,a[b+"Axis"].domain);"x"==b?p.scale(h):q.scale(g);k(b)}function y(b,c){var e="x"==b?h:g,d;b=b.toLowerCase();c&&(a[b+"Axis"].domain=
...
function(c,d){return"pie category_"+c.data[a.series[b].categories]+" value_"+c.data[a.series[b].values]+" "+a.series[b].cssClass}).attr("fill",function(c,d){return A("category_"+c.data[a.series[b].categories]+"value_"+c.data[a.series[b].values])}).transition().call(function(a){m(a,b,"onChange")}).attr("d",d);n.data(k(c)).exit().transition().call(function(a){m(a,b,"onChange")}).remove();Q(b);break;case "area":case "line":c=d3.svg.line().x(function(b,c){return h(b[a.xAxis.values])}).y(function(c,d){return g(c[a.series[b].values])});
"area"==a.type&&(d=d3.svg.area().x(function(b){return h(b[a.xAxis.values])}).y0(a.height-a.margin.top-a.margin.bottom).y1(function(c){return g(c[a.series[b].values])}),l.select(".series"+b).select("path.area").data([a.data]).transition().call(function(a){m(a,b,"onChange")}).attr("d",d));l.select(".series"+b).select("path.line").data([a.data]).transition().call(function(a){m(a,b,"onChange")}).attr("d",c);break;case "scatter":c=l.select(".series"+b).selectAll("circle");c.data(a.data).transition().call(function(a){m(a,
b,"onChange")}).attr("cx",function(b){return h(b[a.xAxis.values])}).attr("cy",function(c){return g(c[a.series[b].values])}).attr("r",function(c,d){return"function"==typeof a.series[b].radius?a.series[b].radius(c,d):"number"==typeof a.series[b].radius?a.series[b].radius:2.5});c.data(a.data).enter().append("circle").attr("class","series"+b+" line "+a.series[b].values+" "+a.series[b].cssClass).attr("fill",a.series[b].color).attr("stroke",a.series[b].color).transition().call(function(a){m(a,b,"onAdd")}).attr("cx",
function(b){return h(b[a.xAxis.values])}).attr("cy",function(c){return g(c[a.series[b].values])}).attr("r",function(c,d){return"function"==typeof a.series[b].radius?a.series[b].radius(c,d):"number"==typeof a.series[b].radius?a.series[b].radius:2.5});c.data(a.data).exit().transition().call(function(a){m(a,b,"onRemove")}).remove();break;case "stack":var f=0,f="ordinal"==a.xAxis.type?h.rangeBand():(a.width-a.margin.left-a.margin.right)/a.data.length,f=2>f?2:f,d=N()[b],c=l.select(".series"+b).selectAll("rect");
c.data(d).enter().append("svg:rect").attr("x",function(a){return h(a.x)}).attr("y",function(b){var c=a.height-a.margin.top-a.margin.bottom-g(b.y);b=a.height-a.margin.top-a.margin.bottom-g(b.y0);return a.height-a.margin.top-a.margin.bottom-c-b}).attr("height",function(b){return a.height-a.margin.top-a.margin.bottom-g(b.y)}).attr("fill",a.series[b].color).attr("width",f);break;case "bar":case "column":var d=a.stacked?N()[b]:a.data,p=function(c,d){var h=a.drawHeight-g(c.y),k=a.drawHeight-g(c.y0);if("column"==
a.type&&a.stacked)return a.drawHeight-h-k;if("column"==a.type)return g(c[a.series[b].values]);if(!a.stacked)return d*f*a.series.length+f*b+1},q=function(c,d){if("column"==a.type&&a.stacked)return h(c.x);if("column"==a.type)return d*f*a.series.length+f*b+1;if(!a.stacked)return 0},r=function(c){if("column"==a.type&&a.stacked)return a.drawHeight-g(c.y);if("column"==a.type)return a.drawHeight-g(c[a.series[b].values]);if(!a.stacked)return f-2},f=0,f="column"==a.type?"ordinal"==a.xAxis.type?h.rangeBand():
(a.width-a.margin.left-a.margin.right)/a.data.length:"ordinal"==a.yAxis.type?g.rangeBand():(a.height-a.margin.top-a.margin.bottom)/a.data.length,f=a.stacked?f:f/a.series.length,f=2>f?2:f,c=l.select(".series"+b).selectAll("rect");c.data(d).transition().call(function(a){m(a,b,"onChange")}).attr("y",function(a,b){return p(a,b)}).attr("x",function(a,b){return q(a,b)}).attr("height",function(a){return r(a)}).attr("width",function(c){return"column"==a.type?f-2:h(c[a.series[b].values])});c.data(d).enter().append("rect").attr("class",
"series"+b+" line "+a.series[b].values+" "+a.series[b].cssClass).attr("fill",a.series[b].color).transition().call(function(a){m(a,b,"onAdd")}).attr("y",function(a,b){return p(a,b)}).attr("x",function(a,b){return q(a,b)}).attr("height",function(a){return r(a)}).attr("width",function(c){return"column"==a.type?f-2:h(c[a.series[b].values])})}})}function m(b,c,d){if(a.series[c][d])a.series[c][d](b,d);else b.duration&&b.duration(a.animation.duration).ease(a.animation.easing)}function O(){D=D||n.append("svg");
x=x||D.append("g").attr("class","chart");z=z||a.title?D.append("text").text(a.title).attr("class","title").attr("y",a.margin.top-a.margin.top/2):null;t=t||a.legend?n.append("div").attr("class","legend"):null;l=l||x.append("g").attr("class","series");"pie"!==a.type&&(E=E||x.append("g").attr("class","axes"),w=w||E.append("g").attr("class","x axis"),B=B||E.append("g").attr("class","y axis"));L();F(!1);"pie"!==a.type&&(p.orient("bottom"),q.orient("left"),C("x"),C("y"),s("x"),s("y"));a.series.forEach(function(a,
c){H(c)})}var d={},n=null,D=null,x=null,l=null,z=null,t=null,E=null,w=null,B=null,p=d3.svg.axis(),q=d3.svg.axis(),h=d3.scale.linear(),g=d3.scale.linear();a&&(n="string"==typeof a.element?d3.select(a.element):n,n.attr("class","cd3").html(""),J(a));d.config=function(b){if(!arguments.length)return a;b.element=a.element;J(b);return d};d.margin=function(b){if(!arguments.length)return a.margin;a.margin=K(b);F("auto");k();return d};d.data=function(b){if(!arguments.length)return a.data;0<b.length&&(a.data=
L(),"pie"!==a.type&&(y("x"),y("y"),k("x"),k("y")),u());return d};d.d3xAxis=function(){return p};d.d3yAxis=function(){return q};d.d3xScale=function(a){return arguments.length?(s("x",a),d):h};d.d3yScale=function(a){return arguments.length?(s("y",a),d):g};d.xScale=function(b){return arguments.length?(s("x",b),d):a.xAxis.scale};d.yScale=function(b){return arguments.length?(s("y",b),d):a.yAxis.scale};d.xDomain=function(b){return arguments.length?(y("x",b),k("x"),u(),d):a.xAxis.domain};d.yDomain=function(b){return arguments.length?
(y("y",b),k("y"),u(),d):a.yAxis.domain};d.xRange=function(b){return arguments.length?(v("x",b),k("x"),d):a.xAxis.range};d.yRange=function(b){return arguments.length?(v("y",b),k("y"),d):a.yAxis.range};d.seriesValues=function(b,c){var e="number"==typeof b?!0:!1;if(e&&!c)return a.series[b].values;e&&c&&(a.series[b].values=c,u(b));return d};d.addSeries=function(b){arguments.length&&(a.series.push(b),H(a.series.length-1));return d};d.hideSeries=function(b){if(arguments.length&&"number"==typeof b&&a.series[b]){var c=
